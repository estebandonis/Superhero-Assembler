...
import { View, Text, RoundedButtonWithIcon, LoadingComponent, ItemList, SuperheroRenderComponent, AddHeroModal, SuperheroPreview } from "@/components";
...
export default function TeamDetail() {
    ...
    const handleSuperHeroPress = (id: number) => {
        router.push({
