...
import { View, Text, RoundedButtonWithIcon, LoadingComponent, ItemList, SuperheroRenderComponent } from "@/components";
  ...
  return (
    <SafeAreaView style={styles.container}>
        <View style={styles.headerContainer}>
            ...
            <RoundedButtonWithIcon icon={<FontAwesome6 name="plus" size={14} color="white" />} onPress={() => {}} />
        </View>
